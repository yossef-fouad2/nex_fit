...
- **Seed color:** `#FFFFFF` (used to derive `ColorScheme` via `ColorScheme.fromSeed` where applicable).
...
Import tokens via `package:nex_fit/src/theme/theme_constants.dart`.
